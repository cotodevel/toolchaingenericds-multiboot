...
//ARM7.bin
#define NDS_LOADER_IPC_ARM7BIN_CACHED		(NDS_LOADER_IPC_CTXADDR - (64*1024))	//0x023E4000
...
#define NDS_LOADER_IPC_BOOTSTUBARM7_CACHED		(NDS_LOADER_IPC_ARM7BIN_CACHED - (64*1024))	//0x023D4000	-> same as IWRAMBOOTCODE	(rwx)	: ORIGIN = 0x023D4000, LENGTH = 64K (arm7bootldr.bin) entry address
#define NDS_LOADER_IPC_BOOTSTUBARM7_UNCACHED 	(NDS_LOADER_IPC_BOOTSTUBARM7_CACHED | 0x400000)

//ARM7 DLDI section code
#define NDS_LOADER_DLDISECTION_CACHED		(NDS_LOADER_IPC_BOOTSTUBARM7_CACHED - (16*1024))	//0x023D0000
#define NDS_LOADER_DLDISECTION_UNCACHED 	(NDS_LOADER_DLDISECTION_CACHED | 0x400000)

//total used: 196.608 bytes = 0x30000
